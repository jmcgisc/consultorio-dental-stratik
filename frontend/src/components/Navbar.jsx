...
export default function Navbar() {
  ...
  const anchors = {
    ...
    ortodonciaGeneral: "/servicios/ortodoncia-general",
    implantologia: "/servicios/implantologia",
          ...
          <div className="hidden lg:flex items-center gap-6 text-brand-600" ref={dropdownRef}>
            ...
            >
              <button
                ...
                className={`${link(false)} flex items-center gap-1 ${servicesOpen ? 'bg-brand-50 dark:bg-neutral-800 text-brand-600' : ''}`}
                aria-haspopup="menu"
              ...
              {servicesOpen && (
                ...
                >
                  ...
                  <div className="relative space-y-1 z-10">
                    ...
                    <a className="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-red-50 dark:hover:bg-red-900/20 text-neutral-700 dark:text-neutral-300 hover:text-red-600 transition-all" href={anchors.implantologia} onClick={() => setServicesOpen(false)}>
